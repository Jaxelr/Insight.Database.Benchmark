...
public class InsightBenchmarkWrite : InsightBenchmark
{
    ...
    {
        post.Id = param;
        return connection.QueryOntoSql("UPDATE Post SET `Text` = @Text, CreationDate = @CreationDate, LastChangeDate = @LastChangeDate WHERE Id = @Id", post);
    }
    ...
    {
        post.Id = param;
        return await connection.QueryOntoSqlAsync("UPDATE Post SET `Text` = @Text, CreationDate = @CreationDate, LastChangeDate = @LastChangeDate WHERE Id = @Id", post);
    }
}
